...
lcfrefute (And (Atom (R ("p", [Fn ("1", [])])),
 And (Not (Atom (R ("q", [Fn ("1", [])]))),
  Forall ("x",
   Imp (Atom (R ("p", [Var "x"])), Atom (R ("q", [Var "x"]))))))) 1 simpcont;;

lcfrefute (And (Exists ("x", Not (Atom (R ("p", [Var "x"])))),
 Forall ("x", Atom (R ("p", [Var "x"]))))) 1 simpcont;;
