...
[Iff (Atom (P "p"), And (Atom (P "q"), Atom (P "r")));
 Iff (Atom (P "p"), Or (Atom (P "q"), Atom (P "r")));
 Iff (Atom (P "p"), Imp (Atom (P "q"), Atom (P "r")));
 Iff (Atom (P "p"), Iff (Atom (P "q"), Atom (P "r")))]
  and p = Atom (P ("p")) and q = Atom (P ("q")) and r = Atom (P ("r"))
