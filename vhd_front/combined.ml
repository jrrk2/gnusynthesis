...
| Double(VhdPackageBodySubProgramBody,Quadruple(Vhdsubprogram_body,Double(VhdProcedureSpecification,
	...
	lst2)),lst3,lst4)) -> Septuple(Str "309",str0,match_combined lst0,match_combined lst1,
...
| Double(VhdPackageSubProgramDeclaration,Double(VhdProcedureSpecification,Quintuple(Vhdprocedure_specification,
	Double(VhdDesignatorIdentifier,str0),lst0,lst1,lst2))) -> Quintuple(Str "310",str0,
...
| Double(VhdSequentialLoop,Quadruple(Vhdloop_statement,Str "",Double(VhdForLoop,Triple(Vhdparameter_specification,
	str0,Double(VhdRange,Triple(VhdIncreasingRange,Double(VhdIntPrimary,num0),Triple(VhdDivTerm,
	Double(VhdNamePrimary,Double(VhdAttributeName,exp0)),Double(VhdIntPrimary,num1)))))),
	lst0)) -> Sextuple(Str "311",str0,num0,num1,match_combined lst0,match_combined exp0)
| Double(VhdSequentialLoop,Quadruple(Vhdloop_statement,Str "",Double(VhdForLoop,Triple(Vhdparameter_specification,
...
| Double(VhdSequentialVariableAssignment,Double(VhdSimpleVariableAssignment,Quadruple(Vhdsimple_variable_assignment,
	...
	str0),lst0)),Double(VhdNamePrimary,Double(VhdSimpleName,str1))))) -> Quadruple(Str "312",
	str0,str1,match_combined lst0)
| Double(VhdSequentialVariableAssignment,Double(VhdSimpleVariableAssignment,Quadruple(Vhdsimple_variable_assignment,
	Str "",Double(VhdTargetDotted,Triple(VhdNameParametersPrimary,Double(VhdSimpleName,
	str0),lst0)),Triple(VhdNameParametersPrimary,Double(VhdSimpleName,str1),lst1)))) -> Quintuple(Str "313",
	str0,str1,match_combined lst0,match_combined lst1)
| Double(VhdSequentialVariableAssignment,Double(VhdSimpleVariableAssignment,Quadruple(Vhdsimple_variable_assignment,
...
| Triple(VhdEqualRelation,Triple(VhdModTerm,Double(VhdNamePrimary,Double(VhdAttributeName,
	exp0)),Double(VhdIntPrimary,num0)),Double(VhdIntPrimary,num1)) -> Quadruple(Str "314",
...
| Triple(Vhdassociation_element,VhdFormalIndexed,Double(VhdActualDiscreteRange,Double(VhdRange,
	...
	Double(VhdNamePrimary,Double(VhdSimpleName,str0)),Double(VhdIntPrimary,num2)))))) -> Sextuple(Str "315",
	str0,num0,num1,num2,match_combined exp0)
| Triple(Vhdassociation_element,VhdFormalIndexed,Double(VhdActualDiscreteRange,Double(VhdRange,
...
| Triple(Vhdassociation_element,VhdFormalIndexed,Double(VhdActualDiscreteRange,Double(VhdRange,
	...
	str0)),Double(VhdIntPrimary,num0)),Triple(VhdSubSimpleExpression,Triple(VhdMultTerm,
	Double(VhdParenthesedPrimary,exp0),Double(VhdIntPrimary,num1)),Double(VhdIntPrimary,
	num2)))))) -> Sextuple(Str "316",str0,num0,num1,num2,match_combined exp0)
...
| Triple(Vhdassociation_element,VhdFormalIndexed,Double(VhdActualExpression,Triple(VhdSubSimpleExpression,
	...
	num0)),Double(VhdNamePrimary,Double(VhdSimpleName,str0))))) -> Quadruple(Str "317",
	str0,num0,match_combined exp0)
| Triple(Vhdassociation_element,VhdFormalIndexed,Double(VhdActualExpression,Triple(VhdSubSimpleExpression,
	Triple(VhdNameParametersPrimary,Double(VhdSimpleName,str0),lst0),Double(VhdIntPrimary,
