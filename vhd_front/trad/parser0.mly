...
%type <Parsetree0.structure> implementation
%start interface                        /* for interface files */
%type <Parsetree0.signature> interface
%start toplevel_phrase                  /* for interactive use */
%type <Parsetree0.toplevel_phrase> toplevel_phrase
%start use_file                         /* for the #use directive */
%type <Parsetree0.toplevel_phrase list> use_file
